...
export class RemoveResultsPageConfirmationPage extends BasePage {
    // ===== Locators =====
    ...
    private readonly yesRadio: Locator =
        this.form.locator('#finished-yes')
            .or(this.form.locator('input[type="radio"][name="DeleteContent"][value="true"]'))
            .first();

    private readonly noRadio: Locator =
        this.form.locator('#finished-no')
            .or(this.form.locator('input[type="radio"][name="DeleteContent"][value="false"]'))
            .first();

    private readonly radios: Locator = this.form.locator('input[type="radio"][name="DeleteContent"]');
