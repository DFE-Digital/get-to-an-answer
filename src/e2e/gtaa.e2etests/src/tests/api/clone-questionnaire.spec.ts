...
async function postClone(request: any, questionnaireId: string, body: { title: string }, token = JwtHelper.ValidToken) {
    return request.post(`${API}/api/questionnaires/${questionnaireId}/clones`, {
        data: body,
        headers: {
