...
test.describe('Get to an answer views questionnaire', () => {
    ...
    //
    //     addQuestionnairePage = await AddQuestionnairePage.create(page);
    //     await addQuestionnairePage.addQuestionnaire('New Questionnaire title');
    //    
    //     await addQuestionnairePage.ClickBackToQuestionnaireLink();
    //
    //     await viewQuestionnairePage.table.expectRowPresentByName('New Questionnaire title');
    //
    //     // based on unique title this will return the status as draft 
    //     //await viewQuestionnairePage.table.getStatus('New Questionnaire title');
    // });
